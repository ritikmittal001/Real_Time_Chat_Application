          ...
          >
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                ...
                <p className="opacity-50 text-sm cursor-pointer">56756 Ratings</p>
                <p className="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500 cursor-pointer">6789 Reviews</p>
                </div>
              ...
              <form className="mt-10">
                ...
                <MuiButton  variant="contained" sx={{px:"2rem",py:"1rem",bgcolor:"#9155fd", marginTop: "1rem" }}>
                Add To Cart
                </MuiButton>
              </form>
            </div>
            ...
            <div className="space-y-5">
              ...
              <Grid item xs={5}>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-60 gap-3">345678 Ratings</p>
                </div>
                    ...
                    <Grid item xs={7}>
                    <LinearProgress sx={{bgcolor:"#d0d0d0",borderRadius:4,height:7}} variant="determinate" value={25} className="bg-blue-500"/>
                    </Grid>
                    </Grid>
